...
const physicalList = [
  ...
  { key: "physical4", value: "Wear cloths that help me feel good about myself" },
...
const psychologicalList = [
  { key: "psychological1", value: "Take time off from work, school and other obligations" },
  { key: "psychological2", value: "Participate in hobbies" },
  { key: "psychological3", value: "Get away from distractions (e.g. phone, email)" },
  { key: "psychological4", value: "Learn new things, un related to work or school" },
  {
    key: "psychological5",
    value:
      "Express my feelings in a health way (e.g. talking, creating art, journaling)",
  },
  { key: "psychological6", value: "Recognize my own strengths and achievements" },
  ...
  { key: "psychological11", value: "Overall psychological and emotional self-care" },
];

const socialList = [
  { key: "social1", value: "Spend time with people who I like" },
  { key: "social2", value: "Call or write to friends and family who are far away" },
...
const spiritualList = [
  ...
  { key: "spiritual4", value: "Recognize the things that give meaning to my life" },
  {
    key: "spiritual5",
    value: "Act in accordance with my morals and values",
  },
  { key: "spiritual6", value: "Set aside time for thought and reflection" },
  { key: "spiritual7", value: "Participate in a cause that is important to me" },
  {
    key: "spiritual8",
    value:
...
const professionalList = [
    ...
    { key: "professional3", value: "Take on projects that are interesting or rewarding" },
    ...
    { key: "professional7", value: "Maintain balance between my professional and personal life" },
    {
      key: "professional8",
      value:
        "Keep a comfortable workspace that allows me to be successful",
    },
    { key: "professional9", value: "Advocate for fair pay, benefits, and other needs" },
